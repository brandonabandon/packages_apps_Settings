...
//    private ColorPickerPreference mBarTransColor;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBarOpaqueColor.setSummary(getResources().getString(R.string.default_text));
...
//        mBarTransColor.setSummary(getResources().getString(R.string.default_text));
//        if (intColor == 0xff000000) {
//            intColor = systemUiResources.getColor(systemUiResources.getIdentifier(
...
//        mBarTransColor.setNewPreviewColor(intColor);
        ...
        mIconColor.setSummary(getResources().getString(R.string.default_text));
