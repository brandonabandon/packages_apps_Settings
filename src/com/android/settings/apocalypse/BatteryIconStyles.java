...
public class BatteryIconStyles extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createCustomView() {
        ...
        if (intColor == -2) {
            ...
            mBatteryColor.setSummary(getResources().getString(R.string.default_text));
        } else {
        ...
        mBatteryTextColor.setSummary(getResources().getString(R.string.default_text));
        ...
        mBatteryTextChargingColor.setSummary(getResources().getString(R.string.default_text));
