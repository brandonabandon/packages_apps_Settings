...
public class LockScreenColorSettings extends SettingsPreferenceFragment implements
    ...
    private static final int SCREWD_PURPLE = 0xff5E1CE2;
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.screwd_lock_screen_color_settings);
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.screwd_lock_screen_color_settings;
                    result.add(sir);
